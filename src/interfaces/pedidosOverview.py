...
dateofCard_2=localizador("Fecha de pedido de la tarjeta","div[class='a-row']>div:nth-child(1)>li>div:nth-child(2) span","css")
...
orderCards_list_bs=localizador("Tarjetas de pedidos","div#yourOrderHistorySection div[class*='a-box-group a-spacing-top-base']","css")  
orderIdOfCard_bs=localizador("Id de pedido de la tarjeta","li#orderIdField","css")
dateofCard_bs=localizador("Fecha de pedido de la tarjeta","div#orderCardHeader div[class='a-row']>div:nth-child(1)>div:nth-child(2)","css")
